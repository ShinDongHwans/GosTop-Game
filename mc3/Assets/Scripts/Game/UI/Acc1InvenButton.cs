...
public class Acc1InvenButton : MonoBehaviour
{
    ...
    {
        currentequip = GameManager.instance.player.equip.accessory1;
        ShowCurrentEquip();
    }
    ...
    {
        GameObject imageview = GameObject.Find("Acc1Image");
        Image image = imageview.GetComponent<Image>();
        GameObject textview = GameObject.Find("Acc1Text");
