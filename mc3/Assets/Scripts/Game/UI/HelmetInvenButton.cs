...
public class HelmetInvenButton : MonoBehaviour
{
    ...
    {
        currentequip = GameManager.instance.player.equip.helmet;
        ShowCurrentEquip();
    }
    ...
    {
        GameObject imageview = GameObject.Find("HelmetImage");
        Image image = imageview.GetComponent<Image>();
        GameObject textview = GameObject.Find("HelmetText");
