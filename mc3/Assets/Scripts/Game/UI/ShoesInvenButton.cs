...
public class ShoesInvenButton : MonoBehaviour
{
    ...
    {
        currentequip = GameManager.instance.player.equip.shoes;
        ShowCurrentEquip();
    }
    ...
    {
        GameObject imageview = GameObject.Find("ShoesImage");
        GameObject textview = GameObject.Find("ShoesText");
