...
public class SubWeaponInvenButton : MonoBehaviour
{
    ...
    {
        currentequip = GameManager.instance.player.equip.subWeapon;
        ShowCurrentEquip();
    }
    
    public void ShowCurrentEquip()
    {
        GameObject imageview = GameObject.Find("SubWeaponImage");
        Image image = imageview.GetComponent<Image>();
        GameObject textview = GameObject.Find("SubWeaponText");
