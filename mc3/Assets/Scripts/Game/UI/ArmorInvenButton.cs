...
public class ArmorInvenButton : MonoBehaviour
{
    ...
    {
        currentequip = GameManager.instance.player.equip.armor;
        ShowCurrentEquip();
    }
    ...
    public void ShowCurrentEquip()
    {
        ...
        GameObject imageview = GameObject.Find("ArmorImage");
        Image image = imageview.GetComponent<Image>();
        GameObject textview = GameObject.Find("ArmorText");
