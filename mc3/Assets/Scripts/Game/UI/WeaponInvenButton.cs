...
public class WeaponInvenButton : MonoBehaviour
{
    ...
    {
        currentequip = GameManager.instance.player.equip.weapon;
        ShowCurrentEquip();
    }

    public void ShowCurrentEquip()
    {
        GameObject imageview = GameObject.Find("WeaponImage");
        Image image = imageview.GetComponent<Image>();
        GameObject textview = GameObject.Find("WeaponText");
