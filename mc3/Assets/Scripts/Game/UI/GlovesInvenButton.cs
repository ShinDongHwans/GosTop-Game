...
public class GlovesInvenButton : MonoBehaviour
{
    ...
    {
        currentequip = GameManager.instance.player.equip.gloves;
        ShowCurrentEquip();
    }
    ...
    {
        GameObject imageview = GameObject.Find("GlovesImage");
        Image image = imageview.GetComponent<Image>();
        GameObject textview = GameObject.Find("GlovesText");
